...
if __name__ == '__main__':
    # 微信配置
    wechat_config = {
        'appid': 'xxxxxxxxxx', #(No.1)此处填写你的appid
        'appsecret': 'xxxxxxxxxxxxxxxx', #(No.2)此处填写你的appsecret
        'template_id': 'xxxxxxxxxxxxxxxxxxxxxx' #(No.3)此处填写你的模板消息ID
    ...
    # 用户列表
    openids = [
        'xxxxxxxxxxxxxxx', #(No.4)此处填写你的微信号（微信公众平台上你的微信号）
        #'xxxxx', #如果有多个用户也可以
        #'xxxxx',
    ]

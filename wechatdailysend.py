...
if __name__ == '__main__':
    # 微信配置
    wechat_config = {
        'appid': 'wx0c89dfe858ea8a66', #(No.1)此处填写你的appid
        'appsecret': '88e57a9792d80b3f154c787a024fe136', #(No.2)此处填写你的appsecret
        'template_id': '5FHfpN6hbepLI_dMopCgnFF5ho6EbL8Xd6e3ACqhD1A' #(No.3)此处填写你的模板消息ID
    ...
    # 用户列表
    openids = [
        'o_hBn61ajNK_KIPe-cKnTJRxF_6Y', #(No.4)此处填写你的微信号（微信公众平台上你的微信号）
        #'xxxxx', #如果有多个用户也可以
        #'xxxxx',
    ]
    ...
    info = {
        'city' : '海宁', #城市
        'name' : '琪琪',    #姓名
        'annorday': '2020-11-3', #恋爱纪念日
        'birthday':'2002-01-16' #生日
    }
    #主方法
    def main():
        # 执行
